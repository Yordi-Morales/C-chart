...
{
    internal class Tiquete_Internacional_Salida
    {
        ...
        public Tiquete_Internacional_Salida()
        {
            this.id = "";
            this.numpasaporte = "";
            this.fecha = "";
        ...
        public Tiquete_Internacional_Salida(string id,string numpasaporte, string fecha, string hora,string numautobus, string asiento, string salida, string destino, string equipaje)
        {
            this.id = id;
