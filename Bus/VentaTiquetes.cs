...
namespace ProyectoII_Tiquete_bus
{
    public partial class VentaTiquetes : Form
    {
        ...
        //Este boton es el boton comprar el cual valida un contador para una x cantidad de ventas
        ...
        private void btnPrincipal_Click(object sender, EventArgs e)
        {
            ...
            if ((cantidadasientos = int.Parse(numCantidadPas.Text)) != contador)
            {
                ...
                else
                {
                    ...
                    Tiquete_Nacional venta = new Tiquete_Nacional
                    {
                        Fecha = dia2,
                        Asiento = asiento,
                        Hora = hora,
                    ...
                    DatosTiquetes.GuardarDatos(venta);
        ...
        private void btnDisponibilidad_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    dia2 = dateTimePicker1.Text;
                    hora = cboHoraSalida.GetItemText(cboHoraSalida.SelectedItem)+":00";
                    salida = cboSalida.GetItemText(cboSalida.SelectedItem);

                    bool validado = validacion(hora, dia2, salida);

                    MessageBox.Show(hora + dia2 + salida);

                    if (validado == true)
                    {
                        List<AsientoTemp> lista2 = DatosTiquetes.Consultarfecha(dia2, hora);
        ...
        public bool validacion(string a1, string a2, string a3)
        {
            ...
            List<Tiquete_Nacional> lista1 = DatosTiquetes.todo();
